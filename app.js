...
cmd.hear(/^(?:коммент) (.*) (.*)$/i, async(message) => {
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 1/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 2/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 3/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 4/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 5/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 6/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 7/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 8/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 9/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 10/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 11/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 12/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 13/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 14/15', message_id: message.id + 1})
    ...
    vk.api.messages.edit({peer_id: message.peerId, message: 'Выполняю... 15/15', message_id: message.id + 1})
